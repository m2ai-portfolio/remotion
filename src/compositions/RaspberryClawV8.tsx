...
// V8 changes from V7:
//   - Outro narration extended (take2): adds "All of the tabs are functional
//     and new agents can be added. It's a new install with no history so
//     there's not much to show." — now 12.93s (was 5.41s in V7)
//   - Same cuts and intro as V7
...
export const RaspberryClawV8: React.FC = () => (
