...
// V7 changes from V6:
//   - Cut C: V6 [01:28.00, 01:44.02) removed (16.0s, end of subC + XFADE + start of fast2x_pre)
//   - Intro narration regenerated (take2): "system" instead of "systemd", "I'll skip the Anthropic
//     key and install" — 84.85s (was 86.60s in take1)
//   - Outro narration unchanged from V6
...
// V7 timeline (3461 frames total = 115.37s @ 30fps):
//   subA1            V7 [   0,  488)  src [   0,  488) 1x   — kept from V5
//   subA2            V7 [ 488,  521)  src [ 544,  577) 1x   — kept from V5
//   subB1            V7 [ 521, 1500)  src [1176, 2155) 1x   — subB truncated at Cut A
//   subC1a           V7 [1500, 2640)  src [2664, 3804) 1x   — subC truncated at Cut C
//   fast2x_pre_post  V7 [2640, 2766)  src [4876, 5128) 2x   — Cut C end through end of fast2x_pre,
//                                                             fade-in to mask 1x→2x speed jump
//   fast2x_post      V7 [2766, 3461)  src [5960, 7350) 2x   — Cut B end through end of source
...
const NARRATION_OUTRO_FRAME = 2766; // start of fast2x_post (V7 92.2s)
...
export const RaspberryClawV7: React.FC = () => (
